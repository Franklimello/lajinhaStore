...
const Mercearia = memo(function Mercearia({ searchTerm = "", isPreview = false }) {
  ...
  const fetchProducts = async (isLoadMore = false) => {
    try {
      ...
      if (!isLoadMore) {
        ...
        if (cached) {
          ...
          if (Date.now() - timestamp < CACHE_TTL) {
            console.log(`✅ Cache hit: Mercearia (${products.length} produtos)`);
      ...
      console.log(`✅ Carregados ${newProducts.length} produtos de Mercearia`);
      ...
      console.error("❌ Erro ao buscar produtos da mercearia:", error);
      setAllProducts([]);
      setHasMore(false);
    } finally {
      setLoading(false);
  ...
  return (
    <section className="min-h-screen mt-10 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-white to-blue-50/30 rounded-2xl shadow-xl border-2 border-blue-100 p-6 w-full max-w-3xl">
              <div className="flex flex-col items-center justify-center gap-3">
                <div className="w-full relative">
                  ...
                  <input
                    type="text"
                    placeholder="Buscar produtos de mercearia... (ex: arroz, feijão, óleo)"
                    ...
                    aria-label="Pesquisar produtos de mercearia"
                    autoComplete="off"
                    spellCheck="false"
                    disabled={searching}
                  />
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-3 bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg mb-6">
            <FaShoppingBasket className="text-blue-500 text-xl animate-pulse" />
            <span className="text-sm font-medium text-gray-600 uppercase tracking-wider">
              Produtos Essenciais
            </span>
          </div>

          <h1 className="text-5xl md:text-6xl font-black bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent mb-4">
            Mercearia
          </h1>

          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Produtos essenciais do dia a dia para sua casa
          </p>
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div>
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-indigo-500 text-white px-6 py-3 rounded-xl font-semibold hover:from-blue-600 hover:to-indigo-600 transition-all duration-300 hover:scale-105 shadow-lg"
                >
                          ...
                          className={`w-full py-3 rounded-xl font-semibold text-white transition-all duration-300 transform relative overflow-hidden ${
                            product.esgotado
                              ...
                              : hoveredProduct === product.id
                                ? 'bg-gradient-to-r from-blue-500 to-indigo-500 shadow-lg scale-105'
        ...
        {isPreview && allProducts.length > 10 && (
          <div className="text-center mt-8">
            <button
              onClick={() => window.location.href = '/mercearia'}
              className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-indigo-500 text-white px-6 py-3 rounded-xl font-semibold hover:from-blue-600 hover:to-indigo-600 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl"
            >
