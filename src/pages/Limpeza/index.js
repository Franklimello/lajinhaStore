      ...
      <div className="max-w-7xl mx-auto">
        ...
        {!isPreview && (
          <div className="w-full flex justify-center py-8 mb-8">
            <div className="bg-gradient-to-br from-white to-teal-50/30 rounded-2xl shadow-xl border-2 border-teal-100 p-6 w-full max-w-3xl">
              <div className="flex flex-col items-center justify-center gap-3">
                <div className="w-full relative">
                  ...
                  <input
                    type="text"
                    placeholder="Buscar produtos de limpeza... (ex: detergente, sabão, desinfetante)"
                              ...
                              ${
                                searching 
                                  ...
                                  : localSearchTerm.length >= 3
                                    ...
                                    : 'border-gray-300 bg-white hover:border-teal-300 hover:bg-teal-50/30'
                              } 
        ...
        <div className="text-center mb-12">
          ...
          {!isPreview && localSearchTerm && localSearchTerm.length >= 3 && !searching && (
            <p className="mt-4 text-sm text-gray-600">
              {resultsCount > 0 ? (
                <span>Resultados para "<strong className="text-teal-600">{localSearchTerm}</strong>": {resultsCount} produto{resultsCount !== 1 ? 's' : ''}</span>
              ) : (
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div>
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 bg-gradient-to-r from-teal-500 to-emerald-500 text-white px-6 py-3 rounded-xl font-semibold hover:from-teal-600 hover:to-emerald-600 transition-all duration-300 hover:scale-105 shadow-lg"
                >
          ...
          <div className="flex justify-center mt-8">
            ...
            >
              {loadingMore ? (
                ...
                <>
                  <FaBroom className="text-xl pointer-events-none" />
