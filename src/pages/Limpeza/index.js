...
export default function Limpeza({ searchTerm = "" }) {
    ...
    const fetchData = async () => {
      try {
        ...
        if (sortedProducts.length === 0) {
          console.warn("⚠️ Nenhum produto de Limpeza encontrado.");
        }
                  ...
                  <SwiperSlide key={product.id}>
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        <h3 className="text-sm font-medium text-gray-800 mb-2 line-clamp-2 group-hover:text-teal-600 transition-colors duration-200">
