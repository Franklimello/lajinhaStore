      ...
      if (!isLoadMore) {
        ...
        if (cached) {
          ...
          if (Date.now() - timestamp < CACHE_TTL) {
            ...
            const catOptions = ["Frios e laticínios", "Frios e Laticínios"];
            const bgQuery = query(
      ...
      <section className="min-h-screen bg-gradient-to-br from-yellow-50 via-amber-50 to-orange-50 p-4 md:p-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-20">
            <div className="inline-block animate-spin rounded-full h-16 w-16 border-b-2 border-yellow-500"></div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Queijos, frios e produtos lácteos frescos e saborosos
          </p>
                ...
                {group.map(product => (
                  <SwiperSlide key={product.id}>
                    ...
                    >
                      ...
                      <div className="relative overflow-hidden bg-gradient-to-br from-yellow-100 to-amber-100 aspect-square">
                        <img
