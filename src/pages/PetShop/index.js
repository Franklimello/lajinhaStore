...
import { FaHeart, FaShoppingCart, FaStar, FaEye, FaPaw } from "react-icons/fa";
import { ShopContext } from "../../context/ShopContext";

export default function PetShop({ searchTerm = "" }) {
      ...
      try {
        ...
        const products = querySnapshot.docs
          ...
          .filter(product => {
            ...
            // Aceita "pet shop", "pet", "petshop" ou variações
            return categoria.includes("pet") || 
                   categoria === "pet shop" ||
                   categoria === "petshop";
          });
                  ...
                  <SwiperSlide key={product.id}>
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        <h3 className="text-sm font-medium text-gray-800 mb-2 line-clamp-2 group-hover:text-amber-600 transition-colors duration-200">
