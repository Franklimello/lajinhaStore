...
import { FaHeart, FaShoppingCart, FaStar, FaEye, FaMagic } from "react-icons/fa";
...
export default function Cosmeticos() {
  ...
  // Função para verificar se produto está nos favoritos (array de objetos)
      ...
      <section className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-50 p-4 md:p-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-20">
            ...
            <p className="mt-4 text-gray-600 text-lg">Carregando produtos de beleza...</p>
          </div>
        </div>
      </section>
    );
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex items-center justify-center gap-2 mt-6">
            ...
            <span className="text-gray-600 ml-2">Produtos avaliados com 5 estrelas</span>
          </div>
        </div>
                  ...
                  <SwiperSlide key={product.id}>
                    ...
                    >
                      ...
                      <div className="relative overflow-hidden bg-gradient-to-br from-pink-100 to-purple-100 aspect-square">
                        <img
                          src={product.fotosUrl?.[0] || product.imagem || '/placeholder-cosmetic.jpg'}
                      ...
                      <div className="p-6">
                        ...
                        {/* Nome do produto */}
                        <h3 className="text-sm font-medium text-gray-800 mb-2 line-clamp-2 group-hover:text-pink-600 transition-colors duration-200">
