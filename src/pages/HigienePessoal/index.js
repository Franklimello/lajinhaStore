...
import { FaHeart, FaShoppingCart, FaStar, FaEye, FaSpa } from "react-icons/fa";
import { ShopContext } from "../../context/ShopContext";

export default function HigienePessoal({ searchTerm = "" }) {
      ...
      try {
        ...
        const products = querySnapshot.docs
          ...
          .filter(product => {
            ...
            return categoria.includes("higiene pessoal") || 
                   categoria.includes("higiene") ||
        ...
        console.log(`✅ Encontrados ${sortedProducts.length} produtos de Higiene Pessoal (ordenados A-Z)`);
        
        // Debug: mostrar as categorias encontradas
        if (sortedProducts.length === 0) {
          console.warn("⚠️ Nenhum produto de Higiene Pessoal encontrado. Verificando todas as categorias disponíveis:");
                  ...
                  <SwiperSlide key={product.id}>
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        <h3 className="text-sm font-medium text-gray-800 mb-2 line-clamp-2 group-hover:text-violet-600 transition-colors duration-200">
