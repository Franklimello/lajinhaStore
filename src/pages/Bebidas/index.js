...
import { FaHeart, FaShoppingCart, FaStar, FaEye, FaGlassWhiskey } from "react-icons/fa";
import { ShopContext } from "../../context/ShopContext";

export default function Bebidas({ searchTerm = "" }) {
      ...
      try {
        ...
        const products = querySnapshot.docs
          ...
          .filter(product => {
            ...
            return categoria.includes("bebidas") || categoria === "bebida";
          });
        ...
        console.log(`✅ Encontrados ${sortedProducts.length} produtos de Bebidas (ordenados A-Z)`);
        
        // Debug: mostrar as categorias encontradas
        if (sortedProducts.length === 0) {
          console.warn("⚠️ Nenhum produto de Bebidas encontrado. Verificando todas as categorias disponíveis:");
                  ...
                  <SwiperSlide key={product.id}>
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        <h3 className="text-sm font-medium text-gray-800 mb-2 line-clamp-2 group-hover:text-cyan-600 transition-colors duration-200">
