...
import { FaHeart, FaShoppingCart, FaStar, FaEye, FaSnowflake } from "react-icons/fa";
import { ShopContext } from "../../context/ShopContext";
import SEO from "../../components/SEO";

export default function BebidasGeladas({ searchTerm = "" }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        try {
          ...
          products = querySnapshot.docs
            ...
            .filter(product => {
              ...
              return categoria.includes("geladas") || categoria.includes("bebidas geladas");
            });
        }
        ...
        console.log(`✅ Encontrados ${sortedProducts.length} produtos de Bebidas Geladas (ordenados A-Z)`);
        
        if (sortedProducts.length === 0) {
          console.warn("⚠️ Nenhum produto de Bebidas Geladas encontrado.");
        }
                  ...
                  <SwiperSlide key={product.id}>
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        <h3 className="text-sm font-medium text-gray-800 mb-2 line-clamp-2 group-hover:text-blue-600 transition-colors duration-200">
