...
const Infantil = memo(function Infantil({ searchTerm = "", isPreview = false }) {
  ...
  if (loading && allProducts.length === 0 && !localSearchTerm) {
    return (
      <section className="min-h-screen bg-gradient-to-br from-sky-50 via-blue-50 to-indigo-50 p-4 md:p-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-20">
            <div className="inline-block animate-spin rounded-full h-16 w-16 border-b-2 border-sky-500"></div>
            <p className="mt-4 text-gray-600 text-lg">Carregando produtos infantis...</p>
          </div>
        </div>
      </section>
    );
  ...
  return (
    <section className="min-h-screen mt-10 bg-gradient-to-br from-sky-50 via-blue-50 to-indigo-50 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        
        {/* SearchBar MELHORADA - apenas quando não for preview */}
        {!isPreview && (
          <div className="w-full flex justify-center py-8 mb-8">
            <div className="bg-gradient-to-br from-white to-sky-50/30 rounded-2xl shadow-xl border-2 border-sky-100 p-6 w-full max-w-3xl">
              <div className="flex flex-col items-center justify-center gap-3">
                <div className="w-full relative">
                  ...
                  <input
                    type="text"
                    placeholder="Buscar produtos infantis... (ex: mamadeira, fralda, brinquedo)"
                              ...
                              ${
                                searching 
                                  ...
                                  : localSearchTerm.length >= 3
                                    ...
                                    : 'border-gray-300 bg-white hover:border-sky-300 hover:bg-sky-50/30'
                              } 
                              shadow-sm hover:shadow-lg`}
                    aria-label="Pesquisar produtos infantis"
                    autoComplete="off"
                    spellCheck="false"
                    disabled={searching}
                  />
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-3 bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg mb-6">
            <FaBaby className="text-sky-500 text-xl animate-pulse" />
            <span className="text-sm font-medium text-gray-600 uppercase tracking-wider">
              Para os Pequenos
            </span>
          </div>

          <h1 className="text-5xl md:text-6xl font-black bg-gradient-to-r from-sky-600 via-blue-600 to-indigo-600 bg-clip-text text-transparent mb-4">
            Infantil
          </h1>

          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Produtos especiais para bebês e crianças com todo carinho
          </p>
          ...
          <div className="flex items-center justify-center gap-2 mt-6">
            ...
            <span className="text-gray-600 ml-2">Produtos seguros e de qualidade</span>
          </div>
          ...
          {!isPreview && localSearchTerm && localSearchTerm.length >= 3 && !searching && (
            <p className="mt-4 text-sm text-gray-600">
              {resultsCount > 0 ? (
                <span>Resultados para "<strong className="text-sky-600">{localSearchTerm}</strong>": {resultsCount} produto{resultsCount !== 1 ? 's' : ''}</span>
              ) : (
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div>
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 bg-gradient-to-r from-sky-500 to-blue-500 text-white px-6 py-3 rounded-xl font-semibold hover:from-sky-600 hover:to-blue-600 transition-all duration-300 hover:scale-105 shadow-lg"
                >
                ...
                {group.map(product => (
                  <SwiperSlide key={product.id}>
                    ...
                    >
                      ...
                      <div className="relative overflow-hidden bg-gradient-to-br from-sky-100 to-blue-100 aspect-square">
                        <img
